...
preprocess("/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/_process_data/BIO/final-data.txt", '/content/drive/MyDrive/Colab Notebooks/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/excel_data', "ner_dataset")

labels_path = os.path.join('/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/excel_data/labels.json')
...
for k, v in enumerate(tmp_labels):
    label2id[v] = k
path = '/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/excel_data/'
