...
if __name__ == "__main__":
    input_file = "/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/_process_data/data/annotated-dataset-plant-disease-corpus.txt"
    output_file = "/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/_process_data/BIO/enimex.txt"

    convert_raw_to_enimex(input_file=input_file, output_file=output_file)

    input_file = output_file
    output_file = "/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/_process_data/BIO/stanford.txt"

    convert_enimex_to_stanford(input_file=input_file, output_file=output_file)

    input_file = output_file
    output_file = "/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/_process_data/BIO/BIO.txt"

    convert_stanford_to_bio(input_file=input_file, output_file=output_file)

    input_file = output_file
    output_file = "/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/_process_data/BIO/final-data.txt"
