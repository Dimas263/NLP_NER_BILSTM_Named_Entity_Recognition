...
preprocess("/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/raw_data/train.txt", '/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/mid_data', "train")
preprocess("/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/raw_data/dev.txt", '/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/mid_data', "dev")
preprocess("/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/raw_data/test.txt", '/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/mid_data', "test")

labels_path = os.path.join('/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/mid_data/labels.json')
...
for k, v in enumerate(tmp_labels):
    label2id[v] = k
path = '/content/drive/MyDrive/bert_bilstm_crf_named_entity_recognition/BILSTM-NER/input/mid_data/'
